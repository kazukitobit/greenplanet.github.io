...
$site_top = "https://office-kagent.com";
...
$BccMail = "yoheykondo510@gmail.com,y_kondo@office-kagent.com,keiyaku@office-kagent.com";
...
$require = array('担当者・氏名','電話番号','Email','件名');
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="https://office-kagent.com" target="_blank">- 株式会社ケージェント~KAgent.Inc -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
