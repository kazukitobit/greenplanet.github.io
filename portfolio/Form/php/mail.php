...
$site_top = "http://office-kagent.com";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@office-kagent.com";
...
$Referer_check_domain = "office-kagent.com";
...
$BccMail = "yoheykondo510@gmail.com,y_kondo@excitingworks.jp";
...
$require = array('氏名','ふりがな','性別','西暦（生まれ年）','メールアドレス','希望年収');
...
<input type="button" id="back" onclick="history.back()"><label for="back">前の画面に戻る</label>
<input type="submit" id="submit"><label for="submit">送信する</label>
</p>
</form>
<?php } ?>
</div><!-- /formWrap -->
...
function mailToAdmin($arr,$subject,$mailFooterDsp,$mailSignature,$encode,$confirmDsp){
	$adminBody="「".$subject."」（転職サイト）からメールが届きました。\n\n";
	$adminBody .="＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n\n";
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://office-kagent.com" target="_blank">- 株式会社 ＫＡｇｅｎｔ -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
